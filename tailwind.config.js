...
export default {
  ...
  theme: {
    extend: {
      colors: {
        ' Brixium-purple': { // Renamed to avoid syntax issues, will use as BrixiumPurple
          light: '#A495D9', // Lighter Purple
          DEFAULT: '#7C5DFA', // Primary Purple (was #8B5CF6, making it more vibrant)
          dark: '#5D3EBE',   // Darker Purple
        },
        ' Brixium-gray': { // Renamed
