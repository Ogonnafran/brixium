...
const SignupPage: React.FC = () => {
  ...
  // Default to appSettings.defaultUserCurrency (which is USD) or fallback to USD if settings not loaded
  const [selectedCurrency, setSelectedCurrency] = useState<Currency>(appSettings?.defaultUserCurrency || Currency.USD);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (success) {
      ...
      // Error message is shown via toast by context
    }
  };
